...
const Connect = () => {
  return (
    <div className="px-4 lg:px-[5%] flex justify-center relative min-h-screen" id="contact">
      <div className='text-center flex lg:flex-row flex-col lg:gap-8 gap-5 justify-around text-center items-center max-w-[1400px]'>
        ...
        <div className="flex flex-col lg:w-1/2 w-full bg-white rounded-lg shadow-lg p-6 dark:bg-neutral-700">
